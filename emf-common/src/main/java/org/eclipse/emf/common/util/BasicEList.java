...
{
    private static final Logger  LOGGER           = Logger.getLogger(BasicEList.class.getName());
     ...
     * @param initialCapacity the initial capacity of the list before it must
     *            grow.
     * @exception IllegalArgumentException if the <code>initialCapacity</code>
     *                is negative.
     */
     ...
     * Clients may override {@link #newData newData} to create typed storage in
     * this case.
    ...
    /**
     * Returns an array containing all the objects in sequence.
     * @param array the array that will be filled and returned, if it's big
     *            enough;
     ...
     * and may <b>not</b> assume that the array remains valid as the list is
     * modified.
     ...
     * data.
     * Having this avoids having the byte code that computes the message
     ...
     * @exception IndexOutOfBoundsException if the index isn't within the size
     *                range.
     * @see #resolve
     * @see #basicGet
     */
    ...
    /**
     * Returns the object at the index without {@link #resolve resolving} it and
     ...
     * This implementation delegates to {@link #assign assign}, {@link #didSet
     * didSet}, and {@link #didChange didChange}.
     * @param index the position in question.
     ...
     * This implementation delegates to {@link #didRemove didRemove} and
    ...
    public E remove(int index)
    {
        ...
        if (shifted > 0)
        {
            ...
            {
                LOGGER.warning("index = " + index + ", shifted = " + shifted);
     ...
     * and delegates to {@link #didClear didClear} and {@link #didChange
     * didChange}.
     */
    @Override
    public void clear()
     ...
     * This implementation delegates to {@link #assign assign}, {@link #didMove
     * didMove}, and {@link #didChange didChange}.
     ...
     * @exception IndexOutOfBoundsException if either index isn't within the
     *                size range.
     */
    @Override
     ...
     * to ensure that no additional growth is needed until the size exceeds the
    ...
    public static class UnmodifiableEList<E> extends BasicEList<E>
    {
        ...
        /**
         * Throws an exception.
         * @exception UnsupportedOperationException always because it's not
         *                supported.
         */
        @Override
    ...
    public static class FastCompare<E> extends BasicEList<E>
    {
        ...
        /**
         * Creates an empty instance with the given capacity.
         * @param initialCapacity the initial capacity of the list before it
         *            must grow.
