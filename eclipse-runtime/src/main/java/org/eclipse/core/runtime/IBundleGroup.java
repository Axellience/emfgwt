/*******************************************************************************
 * Copyright (c) 2004, 2006 IBM Corporation and others. This program and the
 ...
 * Bundle groups do not contain their constituents but rather collect them
 * together under a common label. The main role of a bundle group is to report
 * to the system (e.g., the About dialog) what bundles have been installed. They
 * are not intended for use in managing the set of bundles they represent.
 * <p>
 * Since the bulk of the branding related information is specific to the
 * consumer, bundle groups also carry an arbitrary set of properties. The valid
 * set of key-value pairs and their interpretation defined by the consumer in
...
public interface IBundleGroup
{
    ...
    /**
     * Returns the version of this bundle group. Bundle group version strings
     * have the same format as bundle versions (i.e.,
     * major.minor.service.qualifier). Bundle groups are uniquely identified by
     * the combination of their identifier and their version.
     * @see #getIdentifier()
