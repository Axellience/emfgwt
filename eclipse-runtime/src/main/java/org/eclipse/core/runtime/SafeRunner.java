/*******************************************************************************
 * Copyright (c) 2005, 2009 IBM Corporation and others. This program and the
...
public final class SafeRunner
{
     ...
     * <p>
     * In addition to catching all {@link Exception} types, this method also
     * catches certain {@link Error} types that typically result from
     * programming errors in the code being executed. Severe errors that are not
     * generally safe to catch are not caught by this method.
     * </p>
