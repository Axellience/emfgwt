/**
 * <copyright> Copyright (c) 2005, 2013 IBM Corporation and others. All rights
 * reserved. This program and the accompanying materials are made available
 * under the terms of the Eclipse Public License v1.0 which accompanies this
 * distribution, and is available at http://www.eclipse.org/legal/epl-v10.html
 * Contributors: IBM - Initial API and implementation </copyright> $Id:
 * TransactionalCommandStackImpl.java,v 1.10 2008/05/06 15:04:03 cdamus Exp $
 */
...
public class TransactionalCommandStackImpl extends AbstractTransactionalCommandStack
{
    ...
    /**
     * Extends the superclass implementation to first pop the failed command off
     * of the stack, if it was already appended.
     * @since 1.1
     */
    @Override
    ...
    /**
     * Extends the inherited implementation by invoking it within the context of
     * a redo transaction (a read/write transaction with the
     * {@link #getUndoRedoOptions() undo/redo options}).
     */
    @Override
    public void redo()
    ...
    // Documentation copied from the inherited specification
    @Override
    public void executeTriggers(Command command, List<Command> triggers, Map<?, ?> options)
            throws InterruptedException, RollbackException
    {
        ...
        if (!triggers.isEmpty()) {
            ...
            InternalTransaction tx =
                    createTransaction(trigger, makeTriggerTransactionOptions(options));
            ...
            try {
                ...
                if (e instanceof OperationCanceledException) {
                    ...
                    status = new Status(IStatus.ERROR, EMFTransactionPlugin.getPluginId(),
