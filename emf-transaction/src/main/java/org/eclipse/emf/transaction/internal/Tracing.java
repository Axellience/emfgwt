 ...
 * Tracing.java,v 1.3 2007/11/14 18:14:01 cdamus Exp $
 */
...
public class Tracing
{
    ...
    {
        return false;
        // Plugin plugin = EMFTransactionPlugin.getPlugin();
        //
    ...
    public static void catching(Class<?> clazz, String methodName, Throwable throwable)
    {
        ...
        if (shouldTrace(EMFTransactionDebugOptions.EXCEPTIONS_CATCHING)) {
    ...
    public static void throwing(Class<?> clazz, String methodName, Throwable throwable)
    {
        ...
        if (shouldTrace(EMFTransactionDebugOptions.EXCEPTIONS_THROWING)) {
    ...
    /**
     * Gets the current time and date as a string, suitable for including in a
     * trace message.
