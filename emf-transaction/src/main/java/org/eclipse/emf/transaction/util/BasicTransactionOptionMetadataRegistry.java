 ...
 * BasicTransactionOptionMetadataRegistry.java,v 1.1 2008/11/30 16:38:08 cdamus
 * Exp $
 */
 ...
 * @since 1.3
 */
public class BasicTransactionOptionMetadataRegistry extends
        HashMap<Object, Transaction.OptionMetadata> implements Transaction.OptionMetadata.Registry
{
    ...
    protected Transaction.OptionMetadata delegatedGetOptionMetadata(Object option)
    {
        ...
        return (basicDelegate != null)
                ...
                : (delegate != null) ? delegate.getOptionMetadata(option) : null;
    }

    /**
     * Registers an option metadata descriptor.
     * @param metadata the option metadata to register
