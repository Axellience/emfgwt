 ...
 * initial API and implementation Zeligsoft - Bugs 218765, 249690 $Id$
 ****************************************************************************/
...
public interface IBatchValidator extends IValidator<EObject>
{
     ...
     * @see #setOptions(Map)
     */
    Option<ITraversalStrategy> OPTION_TRAVERSAL_STRATEGY = new Option<ITraversalStrategy>(null)
    {
        @Override
     ...
     * validation operation. This is required when using the {@link MarkerUtil}
     * to update the problem markers attached to resources. This is optional
     * because of the increased cost (in time efficiency) of determining the
     * resources. The default value of this option is <code>false</code>.
     * @since 1.3
     * @see #setOptions(Map)
     */
     ...
     * object that I validate. This supports those clients that do not implement
     * a transaction model for which live validation would be appropriate, but
     * which still need to ensure that vital data integrity and other live
     * constraints are satisfied by their models.
     * </p>
     * <p>
     ...
     *         <code>false</code> if I apply only batch constraints (the
     *         default)
     ...
     * iteration of the model sub-trees selected for recursive validation. This
     * is different from the {@link ITraversalStrategy.Recursive} strategy,
