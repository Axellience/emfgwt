 ...
 * initial API and implementation Borland Software - Bug 137213 Zeligsoft - Bug
 * 137213 Mario Winterer - Bug 284348 SAP AG - Bug 284348, Bug 167972
 ****************************************************************************/
...
public final class EMFModelValidationPlugin extends EMFPlugin
{
     ...
     */
    public static final String CONSTRAINT_PROVIDERS_EXT_P_NAME = "constraintProviders"; //$NON-NLS-1$
     ...
     */
    public static final String CONSTRAINT_BINDINGS_EXT_P_NAME = "constraintBindings"; //$NON-NLS-1$

    /**
     * Extension point name for the validation listeners extension point.
     */
    public static final String VALIDATION_LISTENERS_EXT_P_NAME = "validationListeners"; //$NON-NLS-1$

    /**
     * Extension point name for the event types extension point.
     */
    public static final String EVENT_TYPES_EXT_P_NAME = "eventTypes"; //$NON-NLS-1$
    ...
    // context.registerService(DebugOptionsListener.class.getName(),
    // new _DebugOptionsListener(),
    // props);
    // }
    //
    // @Override
    ...
    //
    // /**
    // * This listener triggers the debug options cache invalidation upon
    // * debug options cache change.
    // * @author Boris Gruschko
    // */
    // private static class _DebugOptionsListener implements
    ...
    public static class Tracing
    {
        ...
        /**
         * Retrieves a Boolean value indicating whether tracing is enabled for
         * the specified debug option.
         * @return Whether tracing is enabled for the debug option of the
         *         plug-in.
         * @param option The debug option for which to determine trace
         *        enablement.
         */
        public static boolean shouldTrace(String option)
        {
            if (shouldTrace()) {
                ...
                synchronized (cachedOptions) {
                    ...
                    if (null == value) {
                        value = false; // Boolean.valueOf(org.eclipse.core.runtime.Platform.getDebugOption(option));
         ...
         * @param option The debug option for which to trace.
         * @param valueDescription The description of the value which is
         *        changing.
         * @param oldValue The old value.
         * @param newValue The new value.
         */
        public static void changing(String option, String valueDescription, Object oldValue,
                                    Object newValue)
        {

            if (shouldTrace(option)) {
                trace(PREFIX_CHANGING
                      + valueDescription
                      + SEPARATOR_SPACE
                      + LABEL_OLD_VALUE
         ...
         * @param newValue The new value.
         */
        public static void changing(String option, Class<?> clazz, String methodName,
        ...
        /**
         * Traces the catching of the specified throwable in the specified
         * method of the specified class.
         * @param option The debug option for which to trace.
         * @param clazz The class in which the throwable is being caught.
         * @param methodName The name of the method in which the throwable is
         *        being caught.
         * @param throwable The throwable that is being caught.
         */
        public static void catching(String option, Class<?> clazz, String methodName,
                                    Throwable throwable)
        {

            if (shouldTrace(option)) {

                trace(PREFIX_CATCHING
        ...
        /**
         * Traces the throwing of the specified throwable from the specified
         * method of the specified class.
         * @param option The debug option for which to trace.
         ...
         */
        public static void throwing(String option, Class<?> clazz, String methodName,
                                    Throwable throwable)
        {

            if (shouldTrace(option)) {

                trace(PREFIX_THROWING
                      + throwable.getMessage()
                      + SEPARATOR_SPACE
                      + PARENTHESIS_OPEN
                      + clazz.getName()
    ...
    {
        Tracing.throwing(EMFModelValidationDebugOptions.EXCEPTIONS_THROWING,
                         class1,
                         functionName,
                         exception);
    }
    ...
    {
        // Status s = new Status(IStatus.INFO, plugin.getSymbolicName(), code,
    ...
    /**
     * Creates a localized, parameterized message from the specified pattern in
     * the resource bundle.
     ...
     * locale. For example, in English locales, the result is a comma-separated
     * list with "and" preceding the last item (no commas if there are only two
     * items).
     * </p>
     * <p>
