 ...
 * initial API and implementation Zeligsoft - Bugs 249690, 137213 Borland
 * Software - Bug 137213 SAP AG - Bug 240352 $Id$
 ****************************************************************************/
...
public class ModelValidationService
{
    ...
    // private final IExtensionChangeHandler providersHandler = new
    // IExtensionChangeHandler()
    // {
    //
    // public void addExtension(IExtensionTracker tracker, IExtension extension)
    // {
    // Collection<IProviderDescriptor> added =
    // registerProviders(extension.getConfigurationElements());
    ...
    // private final IExtensionChangeHandler modeledProvidersHandler = new
    // IExtensionChangeHandler()
    // {
    //
    // public void addExtension(IExtensionTracker tracker, IExtension extension)
    ...
    // String extensionUri =
    // elem.getAttribute(ModeledConstraintsConfig.A_CONSTRAINT_RESOURCE_URI);
    //
    // if (extensionUri != null) {
    // try {
    //
    // ModeledConstraintsLoader.getInstance()
    // .loadConstraintBundles(null,
    // URI.createURI(extensionUri),
    // ModelValidationService.this,
    // Platform.getBundle(elem.getContributor()
    // .getName()));
    // }
    // catch (Exception e) {
    ...
    // private final IExtensionChangeHandler listenersHandler = new
    // IExtensionChangeHandler()
    // {
    //
    // public void addExtension(IExtensionTracker tracker, IExtension extension)
    ...
    private void configureConstraints()
    {
        ...
        //
        // IExtensionPoint modeledProvidersExtensionPoint =
        // Platform.getExtensionRegistry()
        // .getExtensionPoint(EMFModelValidationPlugin.getPluginId(),
        ...
        // if (extTracker != null) {
        // extTracker.registerHandler(providersHandler,
        ...
        //
        // for (IExtension extension :
        // modeledProvidersExtensionPoint.getExtensions()) {
    ...
    // List<IProviderDescriptor> result = new
    // java.util.ArrayList<IProviderDescriptor>();
    //
    ...
    private void configureListeners()
    {
        ...
        //
        // if (extTracker != null) {
        // extTracker.registerHandler(listenersHandler,
        // ExtensionTracker.createExtensionPointFilter(extPoint));
        //
        // for (IExtension extension : extPoint.getExtensions()) {
     ...
     * objects, notifications, or features, according to the value of the
     ...
     * @param mode the evaluation mode for which to create a new validator. Must
     *        not be <code>null</code> or {@link EvaluationMode#NULL}
    ...
    /**
     * Removes a <code>listener</code> from the service. This method has no
     * effect if the <code>listener</code> is not currently registered.
    ...
    /**
     * Broadcasts the specified <code>event</code> to all listeners. This method
     * is used internally by validators to send notifications when they perform
    ...
    /**
     * <p>
     * Loads all available XML-declared constraint descriptors. This is not a
     * very heavy-weight operation, as it does not require the loading of any
     * plug-ins or even the instantantiation of any constraints. It only loads
     * the constraint descriptors that are statically declared in XML.
     * </p>
     * <p>
    ...
    public static EClass findClass(String namespaceUri, String className)
    {
        ...
        if (epackage != null) {
            ...
            if (packageNames == null) {
                ...
                className = className.substring(className.lastIndexOf('.') + 1); // known
                                                                                 // BMP
                                                                                 // code
                                                                                 // point
     ...
     * @return the package names in right-to-left order, as a list of strings,
     *         or <code>null</code> if the class name is not qualified
     */
    private static List<String> parsePackageNames(String qualifiedClassName)
    {
        ...
        if (end >= 0) {
            ...
            // reverse order
            do {
                int start = qualifiedClassName.lastIndexOf('.', end - 1); // known
                                                                          // BMP
                                                                          // code
                                                                          // point
    ...
    /**
     * Implementation of a lazily-initialized validation listener registered on
     * the <tt>validationListener</tt> extension point. On any callback, the
     * lazy listener is replaced by the real one so that it will not be invoked
     * a second time.
     * @author Christian W. Damus (cdamus)
     */
    ...
    // EMFModelValidationPlugin.getMessage(EMFModelValidationStatusCodes.LISTENER_UNCAUGHT_EXCEPTION_MSG,
    // new Object[]{config.getDeclaringExtension()
    // .getUniqueIdentifier()}),
    // e);
