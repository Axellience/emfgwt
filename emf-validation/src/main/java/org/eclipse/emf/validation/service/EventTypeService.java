/******************************************************************************
 * Copyright (c) 2007, 2008 IBM Corporation, Zeligsoft Inc., and others. All
 * rights reserved. This program and the accompanying materials are made
 * available under the terms of the Eclipse Public License v1.0 which
 * accompanies this distribution, and is available at
 * http://www.eclipse.org/legal/epl-v10.html Contributors: IBM Corporation -
 * initial API and implementation Zeligsoft - Bugs 249690, 137213
 ****************************************************************************/
 ...
 * types that have been contributed. It provides accessor methods for retrieving
 * {@link INotificationGenerator}s that have been contributed along with the
 * {@link EMFEventType}s.
 * @since 1.1
...
public class EventTypeService
{
    ...
    // INotificationGenerator>(notificationGenerators);
    //
    ...
    // Boolean.valueOf(element.getAttribute(A_FEATURE_SPECIFIC))
    // .booleanValue());
    //
    ...
    // {
    // notificationGenerators.put(name,
    // (INotificationGenerator)
    // element.createExecutableExtension(A_NOTIFICATION_GENERATOR));
    // }
    // }
    // }
