...
public class TextUtils
{
     ...
     * display in error messages. If no suitable factory is registered, then the
     * EMF reflective item provider is used.
    ...
    public static String getText(EObject eObject)
    {
        IItemLabelProvider provider =
                (IItemLabelProvider) factory.adapt(eObject, IItemLabelProvider.class);
