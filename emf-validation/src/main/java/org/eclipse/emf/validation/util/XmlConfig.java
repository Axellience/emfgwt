...
/**
 * <p>
 * Static utilities for loading the constraint provider configurations from XML
 * documents.
 * </p>
 * <p>
...
public class XmlConfig
{
     ...
     *        Eclipse's extension point parser or from this utility class
     ...
     *         existing configuration element or in parsing the XML to create
     *         new ones
    ...
    // element.getDeclaringExtension().getNamespaceIdentifier()).getEntry("/");
    // //$NON-NLS-1$
    // }
    // }
     ...
     * <code>url</code>.
     * @param parent the configuration element which is to be the parent of the
     *        new <tt>&lt;constraints&gt;</tt> element
     ...
     * @noreference This method is not intended to be referenced by clients.
     */
    // public static IConfigurationElement load(IConfigurationElement parent,
    // URL url)
    ...
    // parent.getDeclaringExtension().getNamespaceIdentifier();
    //
    ...
    /**
     * Obtains an array including all of the <tt>event</tt> and
     * <tt>customEvent</tt> children of the specified <tt>config</tt>uration
     * element.
     ...
     * @noreference This method is not intended to be referenced by clients.
     */
    // public static IConfigurationElement[] getEvents(IConfigurationElement
    // config) {
