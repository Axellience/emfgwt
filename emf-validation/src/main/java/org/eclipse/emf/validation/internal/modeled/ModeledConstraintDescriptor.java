        ...
        implements IParameterizedConstraintDescriptor
{
    ...
    /**
     * Sets the constraint. No reference to the constraint object will be held
     * after this method had been executed.
    ...
    public final void setInitializationData(Constraint constraint)
    {
        ...
        this.id = "dummy";// XmlConstraintDescriptor.normalizedId(pluginId,
                          // constraint.getId());
