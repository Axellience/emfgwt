...
public class EMFConstraintParser implements IParameterizedConstraintParser
{
    ...
    private static final String NO_INTERFACE        =
            "ValidationMessages.emfadapter_noInterface_WARN_";
    private static final String NO_METHOD           =
            "ValidationMessages.emfadapter_noMethod_WARN_";
    private static final String NOT_BOOLEAN         =
            "ValidationMessages.emfadapter_notBoolean_WARN_";
    private static final String ILLEGAL_ACCESS      =
            "ValidationMessages.emfadapter_illegalAccess_WARN_";
    private static final String INTERFACE_NOT_FOUND =
            "ValidationMessages.emfadapter_interfaceNotFound_WARN_";
    private static final String METHOD_NOT_FOUND    =
            "ValidationMessages.emfadapter_methodNotFound_WARN_";

    /** The signature of validation methods in the EMF API. */
    private static final Class<?>[] VALIDATION_METHOD_SIGNATURE =
            new Class<?>[]{DiagnosticChain.class, java.util.Map.class,};
            ...
            throws ConstraintParserException
    {
        ...
        EMFConstraintAdapter result = null;
        ...
        // emfInterface.getMethod(methodName, VALIDATION_METHOD_SIGNATURE);
        //
        ...
        // throw new
        // ConstraintParserException(EMFModelValidationPlugin.getMessage(INTERFACE_NOT_FOUND,
        // new Object[]{className}),
        // e);
        // }
        // catch (NoSuchMethodException e) {
        // throw new
        // ConstraintParserException(EMFModelValidationPlugin.getMessage(METHOD_NOT_FOUND,
        // new Object[]{className,
        // methodName}),
        // e);
        // }
