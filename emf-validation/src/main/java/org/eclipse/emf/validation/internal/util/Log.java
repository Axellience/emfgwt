...
public class Log
{
    ...
    /**
     * Generates a log for this plug-in, with the specified severity, status
     * code, and message.
    ...
    public static void log(int severity, int code, String message, Throwable throwable)
    {
        ...
        Status s = new Status(severity, EMFModelValidationPlugin.getPluginId(), code, message,
                              throwable);
     ...
     * object. Statuses with severity of error or warning result in the
     * generation of a platform log for the specified plug-in; all log requests
     * are forward to the default log listener.
    ...
    /**
     * <p>
     * Logs a localized error message for this plug-in with substitution
     * variables. The message is formatted according to the conventions of the
     * {@link org.eclipse.osgi.util.NLS} class.
     * </p>
     * <p>
     * The value of the <code>patternArgs</code> argument may be a single object
     * if the message pattern requires only one argument (<tt>{0}</tt>), or it
     * may be a collection or an array if multiple arguments are required.
     * </p>
     * @param code the
     *        {@link org.eclipse.emf.validation.internal.EMFModelValidationStatusCodes}
     *        error code
    ...
    /**
     * <p>
     * Logs a localized message for this plug-in with substitution variables.
    ...
    /**
     * <p>
     * Logs a localized message for this plug-in with substitution variables and
     * an exception.
     * </p>
     * @param severity the {@link org.eclipse.core.runtime.IStatus} severity
     *        code
     ...
     * <p>
     * Logs a localized message for this plug-in with substitution variables
     * that are also localized strings. The message is formatted according to
     * the conventions of the {@link org.eclipse.osgi.util.NLS} class.
     * </p>
     * <p>
     * The value of the <code>patternArgKeys</code> argument is an array of
     * other keys in the resource bundle which indicate localizable text
     * fragments to be inserted into the message.
     * </p>
     * @param severity the {@link org.eclipse.core.runtime.IStatus} severity
     *        code
     * @param code the
     ...
     *        error code
     * @param messagePattern the message pattern
     * @param patternArgKeys resource-bundle keys of text to replace the
     *        variables in the message pattern
     */
    public static void l7dMessage(int severity, int code, String messagePattern,
                                  String[] patternArgKeys)
    {
     ...
     * <p>
     * Logs a localized message for this plug-in with substitution variables
     * that are also localized strings, and an exception.
     * </p>
     * @param severity the {@link org.eclipse.core.runtime.IStatus} severity
     *        code
     * @param code the
     ...
     */
    public static void l7dMessage(int severity, int code, String messagePattern,
                                  String[] patternArgKeys, Throwable exception)
    {

        log(severity,
            code,
            EMFModelValidationPlugin.getMessage(messagePattern, (Object[]) patternArgKeys),
            exception);
    }
}
