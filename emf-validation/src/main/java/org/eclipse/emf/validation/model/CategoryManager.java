...
public class CategoryManager
{
    ...
    /**
     * Obtains the category that has the specified <code>path</code> relative to
     * the specified <code>parent</code> category. If this category does not yet
     * exist, it is implicitly created.
    ...
    /**
     * Finds the category that has the specified <code>path</code> relative to
     * the specified <code>parent</code> category. Unlike the
    ...
    public void removeCategory(Category category)
    {
        ...
        IConstraintDescriptor[] constraintsArray =
                constraints.toArray(new IConstraintDescriptor[constraints.size()]);
    ...
    // }
    //
    // IExtensionPoint modeledConstraintsExtensionPoint =
    // Platform.getExtensionRegistry()
    // .getExtensionPoint(EMFModelValidationPlugin.getPluginId(),
    ...
    // String uri =
    // cfg.getAttribute(ModeledConstraintsConfig.A_CONSTRAINT_RESOURCE_URI);
    // if (uri != null) {
    // try {
    // ModeledConstraintsLoader.getInstance()
    // .loadCategories(null,
    // URI.createURI(uri),
    // Platform.getBundle(ext.getContributor()
    // .getName()));
    // }
    // catch (Exception e) {
    // Tracing.catching(EMFModelValidationDebugOptions.EXCEPTIONS_CATCHING,
    // CategoryManager.class,
    // "loadCategories", //$NON-NLS-1$
    // e);
    // }
    // }
    // }
     ...
     * @param element
     */
    // private void loadCategories(Category parent, IConfigurationElement
    // element)
    // {
    ...
    // element.getChildren(XmlConfig.E_CATEGORY);
    //
    ...
    // }
    // } else {
    // Trace.trace(EMFModelValidationDebugOptions.XML,
